  ...
  return (
    <section className='flex items-center justify-around border border-gray-200 rounded-2xl  bg-white dark:bg-slate-900 mt-30 mb-24 overflow-hidden'>
      <div className='w-full flex flex-col items-center justify-center p-8'>
        ...
        <h2 className='text-5xl md:text-4xl md:leading-[3rem] font-semibold max-w-lg bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent font-playfair dark:from-slate-100'>
          With SALON, <br />
