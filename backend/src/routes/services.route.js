...
import { createService, deleteService, getActiveServices, getAllServices, getServiceDetail, likeService, updateService } from "../controllers/service.controller.js";
...
serviceRouter.get("/:id", getServiceDetail);
